...
<body class="bg-zinc-950 text-white font-sans antialiased flex flex-col min-h-screen">
    ...
    <div class="relative z-10 w-full max-w-md mx-auto px-6 py-16 flex-1 flex flex-col items-center">
        ...
        <div class="w-full space-y-4">
            ...
            <a href="/" class="group relative block w-full bg-zinc-900/80 border border-zinc-800 p-4 rounded-xl text-center transition-all duration-300 btn-hover-effect hover:-translate-y-1">
        ...
        <div class="mt-12 flex items-center gap-6 opacity-60">
            <a href="https://tiktok.com/@yourhandle" target="_blank" class="text-zinc-400 hover:text-white transition">
            ...
            <a href="https://instagram.com/yourhandle" target="_blank" class="text-zinc-400 hover:text-white transition">
