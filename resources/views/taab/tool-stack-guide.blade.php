...
<div class="container">
  ...
  <div class="level-section" data-level="int" id="sec-int">
    ...
    <div class="tool-grid">
      ...
      <div class="tool-card"><div class="tool-card-top"><div><div class="tool-name">n8n (self-hosted)</div><div class="tool-category">Workflow automation</div></div><div class="cost-badge cost-free">Free</div></div><div class="tool-desc">Your production setup: n8n self-hosted on Google Cloud's always-free tier. Unlimited workflows, no execution limits, ₦0/mo to run. This is how you do client work without monthly bills.</div><div class="tool-tags"><span class="tag">Production-ready</span><span class="tag">Unlimited execs</span><span class="tag">Free hosting</span></div><div class="tool-cost-detail"><strong>n8n is free</strong> · hosted free on Google Cloud's always-free tier</div></div>
  ...
  <div class="level-section" data-level="adv" id="sec-adv">
    ...
    <div class="tool-grid">
      ...
      <div class="tool-card"><div class="tool-card-top"><div><div class="tool-name">Google Cloud (always-free)</div><div class="tool-category">Hosting / infra</div></div><div class="cost-badge cost-free">Free</div></div><div class="tool-desc">Our main path to ₦0/mo hosting - self-host n8n on Google Cloud's always-free e2-micro VM. Unlimited workflows, no execution limits, no monthly bill. Google asks for a one-time $30 prepayment to activate the account (a Naira card is fine). (Railway / Render are paid one-click alternatives if you prefer.)</div><div class="tool-tags"><span class="tag">Always-free VM</span><span class="tag">Self-host n8n</span><span class="tag">₦0/mo</span></div><div class="tool-cost-detail"><strong>₦0/mo forever</strong> on the always-free tier · one-time $30 Google prepayment, plus a domain (~$10/yr)</div></div>
    </div>
  </div>
  ...
  <div class="combos-section">
    ...
    <div class="combo-card adv"><div class="combo-level">Advanced</div><div class="combo-stack"><span class="combo-tool">n8n (self-hosted)</span><span class="combo-plus">+</span><span class="combo-tool">Pinecone</span><span class="combo-plus">+</span><span class="combo-tool">Vapi</span><span class="combo-plus">+</span><span class="combo-tool">Gemini</span></div><div class="combo-cost">Free self-hosted on Google Cloud — pay only for AI/voice usage · RAG + voice receptionist</div></div>
  </div>
