...
<div class="container">
  ...
  <div class="hero">
    ...
    <p class="hero-sub">Curated by starting level. Every tool listed has been tested in real client workflows — not just mentioned because it is popular. Costs are real monthly figures, not optimistic estimates.</p>
  </div>
  ...
  <div class="level-section" data-level="beg" id="sec-beg">
    ...
    <div class="tool-grid">
      ...
      <div class="tool-card"><div class="tool-card-top"><div><div class="tool-name">Make (formerly Integromat)</div><div class="tool-category">Workflow automation</div></div><div class="cost-badge cost-freemium">Freemium</div></div><div class="tool-desc">Alternative to n8n. More beginner-friendly UI. Great for client demos. Use this if n8n feels overwhelming at first.</div><div class="tool-tags"><span class="tag">Visual builder</span><span class="tag">1,000+ apps</span><span class="tag">Scenario-based</span></div><div class="tool-cost-detail"><strong>Free:</strong> 1,000 ops/mo · <strong>Core:</strong> $9/mo (10k ops)</div></div>
      <div class="tool-card"><div class="tool-card-top"><div><div class="tool-name">ChatGPT (web)</div><div class="tool-category">AI assistant</div></div><div class="cost-badge cost-freemium">Freemium</div></div><div class="tool-desc">Your brainstorming and prompt development partner. Not a deployment tool — use it to prototype logic before wiring it into n8n/Make.</div><div class="tool-tags"><span class="tag">Prototyping</span><span class="tag">Prompt dev</span></div><div class="tool-cost-detail"><strong>Free tier available</strong> · Plus: $20/mo for GPT-4o access</div></div>
  ...
  <div class="level-section" data-level="int" id="sec-int">
    <div class="level-header int">
      ...
      <span class="level-who">Some API comfort · Low-code · $30–80/mo investment</span>
    </div>
    <div class="tool-grid">
  ...
  <div class="level-section" data-level="adv" id="sec-adv">
    <div class="level-header adv">
      ...
      <span class="level-who">Developer skills required · $80–200+/mo investment</span>
    </div>
    <div class="tool-grid">
  ...
  <div class="combos-section">
    ...
    <div class="combo-card beg"><div class="combo-level">Beginner</div><div class="combo-stack"><span class="combo-tool">n8n Cloud</span><span class="combo-plus">+</span><span class="combo-tool">OpenAI API</span><span class="combo-plus">+</span><span class="combo-tool">Airtable</span><span class="combo-plus">+</span><span class="combo-tool">Tally Forms</span></div><div class="combo-cost">~$35–50/mo · Lead capture + AI email drafting</div></div>
    <div class="combo-card int"><div class="combo-level">Intermediate</div><div class="combo-stack"><span class="combo-tool">n8n (self-hosted)</span><span class="combo-plus">+</span><span class="combo-tool">Claude API</span><span class="combo-plus">+</span><span class="combo-tool">WhatsApp API</span><span class="combo-plus">+</span><span class="combo-tool">Airtable</span></div><div class="combo-cost">~$30–60/mo · WhatsApp AI lead qualifier (highest demand in Nigeria)</div></div>
    <div class="combo-card int"><div class="combo-level">Intermediate</div><div class="combo-stack"><span class="combo-tool">n8n (self-hosted)</span><span class="combo-plus">+</span><span class="combo-tool">Cal.com</span><span class="combo-plus">+</span><span class="combo-tool">OpenAI API</span><span class="combo-plus">+</span><span class="combo-tool">Brevo</span></div><div class="combo-cost">~$25–45/mo · Booking + timed email follow-up sequence</div></div>
    <div class="combo-card adv"><div class="combo-level">Advanced</div><div class="combo-stack"><span class="combo-tool">n8n (self-hosted)</span><span class="combo-plus">+</span><span class="combo-tool">Flowise</span><span class="combo-plus">+</span><span class="combo-tool">Pinecone</span><span class="combo-plus">+</span><span class="combo-tool">Supabase</span><span class="combo-plus">+</span><span class="combo-tool">Claude API</span></div><div class="combo-cost">~$60–120/mo · RAG-powered document chatbot for enterprise clients</div></div>
  </div>
