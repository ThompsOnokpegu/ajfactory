...
<div class="container">
  ...
  <div class="level-section" data-level="adv" id="sec-adv">
    ...
    <div class="tool-grid">
      ...
      <div class="tool-card"><div class="tool-card-top"><div><div class="tool-name">Google Cloud (always-free)</div><div class="tool-category">Hosting / infra</div></div><div class="cost-badge cost-free">Free</div></div><div class="tool-desc">Our main path to ₦0/mo hosting — self-host n8n on Google Cloud's always-free e2-micro VM. Unlimited workflows, no execution limits, runs forever at no cost. (Railway / Render are paid one-click alternatives if you prefer.)</div><div class="tool-tags"><span class="tag">Always-free VM</span><span class="tag">Self-host n8n</span><span class="tag">₦0/mo</span></div><div class="tool-cost-detail"><strong>Free forever</strong> on the always-free tier · your only cost is a domain (~$10/yr)</div></div>
    </div>
  </div>
