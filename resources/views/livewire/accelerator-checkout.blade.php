                ...
                <form wire:submit.prevent="initiatePayment" class="space-y-6">
                    ...
                    <label class="flex items-start gap-3 p-4 rounded-xl border border-zinc-800 bg-zinc-900/40 cursor-pointer">
                        ...
                        <span class="text-xs text-zinc-400 leading-snug">
                            ...
                            and understand that beyond tuition I'll need a one-time $30 Google Cloud prepayment (a Naira card works) plus one cheap domain (from ~$10/yr) - or a small paid host (~$10/mo for ~3 months) in place of Google Cloud.
                        </span>
                    </label>
